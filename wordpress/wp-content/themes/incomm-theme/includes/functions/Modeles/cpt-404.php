...
require_once( get_template_directory() . '/includes/functions/Modeles/Icones/icon-404.php' );

function CPT404() {
  $labels = array(
    'name' => __( '404' ),
    'singular_name' => __( '404' ),
    'menu_name' => __( 'Not Found' ),
    'all_items' => __( 'Toutes les 404' ),
    'add_new' => __( 'Ajouter un nouveau' ),
    'add_new_item' => __( 'Ajouter une 404' ),
    'edit_item' => __( 'Modifier les 404' ),
    'new_item' => __( 'Nouvelle 404' ),
    'view_item' => __( 'Voir les 404' ),
    'search_items' => __( 'Rechercher des 404' ),
    'not_found' => __( 'Aucune 404 trouvée' ),
    'not_found_in_trash' => __( 'Aucune 404 trouvée dans la corbeille' ),
  );
  ...
  $args = [
      ...
      'show_in_menu' => true, // ajoute une entrée pour ce type de contenu dans le menu de navigation du tableau de bord WordPress. Si cette clé est définie sur false, le type de contenu ne sera pas visible dans le menu de navigation. Visible/Cache dans bar admin.
...
add_action( 'init', function () { CPT404() ; });
